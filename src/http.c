...
const char *apple_domains[] = {
					...
					"www.applecare.us",
					"www.macbook.us",
					"www.itunesmobile.com",
					"www.ipod.us",
					"www.itunestelevision.com",
					"www.macosxversions.com",
					"www.itunes.me",
					"www.itunesaircheck.com",
					"www.mac.us",
					"www.macbookair.us",
					"www.ipod.me",
					"www.applestore.info",
					"www.iphone.me",
					"www.osxlionlaunchpad.com",
					"www.macgestures.com",
					"www.macbookair.org",
					"www.mac.info",
					"www.macos.us",
					...
					"www.airport.info",
					"www.itunesparty.com",
					"www.applecomputer.info",
					"www.appletv.info",
					"www.applecomputers.us",
					"www.idvd.us",
					"www.osx.info",
					"www.macbookair.info",
					"www.itunesu.org",
